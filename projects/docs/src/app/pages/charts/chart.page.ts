  ...
  template: `
    <main class="mx-auto flex max-w-350 flex-col gap-10 px-4 py-8 sm:px-6 xl:px-0">
      <section class="grid min-w-0 gap-8 lg:grid-cols-[15rem_minmax(0,1fr)] lg:items-start">
        <nav
          class="docs-mobile-nav docs-blueprint-sheet lg:hidden"
          aria-label="Charts mobile navigation"
        >
          <p class="docs-blueprint-meta mb-3">Charts</p>

          <div class="docs-mobile-nav__row">
            <a
              class="docs-mobile-nav__pill"
        ...
        <aside class="hidden min-w-0 lg:sticky lg:top-24 lg:block">
          <div
            class="docs-blueprint-sheet space-y-7 overflow-y-auto overflow-x-hidden p-4 scrollbar-none lg:max-h-[calc(100vh-7rem)]"
          >
            <section>
